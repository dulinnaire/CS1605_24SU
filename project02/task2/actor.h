...
public:
    ...
    virtual void usePotion(PotionInfo potionInfo) {};
    ...
    bool shouldReturnToChooseAction;            // 是否需要重新 ChooseAction
};
...
public:
    ...
    void usePotion(PotionInfo potionInfo) override;
    std::string GetName() override;
};
